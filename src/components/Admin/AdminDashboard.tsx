...
export default function AdminDashboard({ onLogout }: AdminDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {!isFirebaseAuthed && (
        <div className="bg-amber-600 text-white px-4 py-2 flex items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-wider">
          <ShieldAlert className="w-3 h-3" />
          Offline Mode: Read-Only Access until Google Login
        </div>
      )}
